...
switch ($current_tab) {
	case 'email':
		...
		// custom content type for public subcribers

		echo __('Mail content type for Public Subscribers', 'subscribe2') . ': ';
		
		// pre-define default option
		$custom_type_public_subs_checkbox = empty($this->subscribe2_options['custom_type_public_subs']) ? 'html_excerpt' : $this->subscribe2_options['custom_type_public_subs'];
		
			echo "<label><input type=\"radio\" name=\"custom_type_public_subs\" value=\"html\"" . checked( $custom_type_public_subs_checkbox, 'html', false) . " /> ";
			echo __('HTML - Full', 'subscribe2') ."</label>&nbsp;&nbsp;";
			
			echo "<label><input type=\"radio\" name=\"custom_type_public_subs\" value=\"html_excerpt\"" . checked($custom_type_public_subs_checkbox, 'html_excerpt', false) . " /> ";
			echo __('HTML - Excerpt', 'subscribe2') ."</label>&nbsp;&nbsp;";
			
			echo "<label><input type=\"radio\" name=\"custom_type_public_subs\" value=\"plain\"" . checked($custom_type_public_subs_checkbox, 'plain', false) . " /> ";
			echo __('Plain Text - Full', 'subscribe2') . "</label>&nbsp;&nbsp;";
			
			echo "<label><input type=\"radio\" name=\"custom_type_public_subs\" value=\"plain_excerpt\"" . checked($custom_type_public_subs_checkbox, 'plain_excerpt', false) . " /> ";
		...
		echo __('Format', 'subscribe2') . ' mymail@' . $_SERVER['SERVER_NAME'] . ' OR ' . 'Your Name &lt;mymail@' . $_SERVER['SERVER_NAME'] . "&gt;<br />\r\n";
		echo "<label>\r\n";
		echo "<input type=\"text\" name=\"custom_sender\" value=\"" . stripslashes($this->subscribe2_options['custom_sender']) . "\" size=\"45\" />";
		echo "</label><br /><br />\r\n";
	...
	case 'templates':
		...
		echo "</td><td style=\"vertical-align: top;\" rowspan=\"4\">";
		...
		echo __('HTML Mail Header', 'subscribe2') . ":<br />\r\n";
		echo "<textarea rows=\"9\" cols=\"60\" name=\"html_header_template\">" . stripslashes($this->subscribe2_options['html_header_template']) . "</textarea>\r\n";
