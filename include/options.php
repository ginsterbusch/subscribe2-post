...
if (!isset($this->subscribe2_options['custom_sender'])) {
	$this->subscribe2_options['custom_sender'] = "";
} // option for custom email sender


if (!isset($this->subscribe2_options['custom_type_public_subs'])) {
	$this->subscribe2_options['custom_type_public_subs'] = 'html_excerpt';
} // option for switching the mail content type for public subcribers
