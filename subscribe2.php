<?php
/*
Plugin Name: Subscribe2 Post
Plugin URI: http://subscribe2.wordpress.com
Description: Notifies an email list when new entries are posted. An ongoing effort to combine the easy of use of the Subscribe2 plugin by <a href="http://subscribe2.wordpress.com">Matthew Robinson</a> with the flexibility of the Post Notification plugin by <a href="">Moritz Str&uuml;be</a>. 
Version: 9.1
Author: Fabian Wolf
...
/*
Copyright (C) 2013 Fabian Wolf
based on the Original Subscribe2 9.0 plugin by
...
define( 'S2PVERSION', '1.0' );
define( 'S2VERSION', '10.0' );
